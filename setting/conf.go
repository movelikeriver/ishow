...
func LoadConfig() *goconfig.ConfigFile {
	...
	beego.SessionName = Cfg.MustValue("session", "session_name", "ishow_sess")
	...
	dataSource := Cfg.MustValue("orm", "data_source", "root:root@/ishow?charset=utf8&loc=UTC")
...
func reloadConfig() {
	AppName = Cfg.MustValue("app", "app_name", "iShow")
	beego.AppName = AppName

	AppHost = Cfg.MustValue("app", "app_host", "127.0.0.1:9394")
	AppUrl = Cfg.MustValue("app", "app_url", "http://127.0.0.1:9394/")
	...
	CookieRememberName = Cfg.MustValue("app", "cookie_remember_name", "ishow_magic")
	CookieUserName = Cfg.MustValue("app", "cookie_user_name", "ishow_powerful")
	...
	MailUser = Cfg.MustValue("mailer", "mail_name", "iShow")
	...
	// search setting
	SphinxIndex = Cfg.MustValue("search", "sphinx_index", "ishow, ishow_delta")
